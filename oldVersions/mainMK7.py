...
WEPS = {"normal": ["shot", "big shot", "heavy shot", "massive shot", "one-bounce", "three-bounce",
                    ...
                    "firestorm", "sunburst", "solar flare", "payload", "magic shower", "shadow", "darkshadow",
                    "deathshadow", "carpet bomb",
                    ...
                    "mini-turret", "kamikaze", "suicide bomber", "nuke", "meganuke",
...
def pressKey(x, key):
    pyautogui.press(key, presses=x, interval=0.001)
...
def play(waitTime=7, debug=False):
    ...
    while True:
        ...
        if weapon_cat != "instant":
            ...
            else: shoot_data = getBestAngleNORMAL(calc_wind ,myPos[0],enemyPos[0])
